(function () {
    ...
    function initSharaClubPlugin() {
        ...
        if (document.querySelector('.sharaclub-plugin-btn')) return;

        // Создаем элемент кнопки
        const button = document.createElement('div');
        button.classList.add('head__action', 'sharaclub-plugin-btn', 'selector');
